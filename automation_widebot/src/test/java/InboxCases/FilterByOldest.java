...
public class FilterByOldest  extends BaseTests {


    LoginPageSetup loginPageSetup=new LoginPageSetup("widebotpostman@gmail.com","W!deBot12345");

    @Test
    public void SuccessSortByOldestCase() throws InterruptedException {
        ...
        inboxPage.SortByOldest(driver);
        //Assertion for oldest Conversation in list it should be Nada Mohamed
        String FirstNameInConvList = (String) inboxPage.FirstElementInConvList.toString();
        Assert.assertEquals(FirstNameInConvList,"Nada Mohamed");
